...
{  
   ...
   // //Test case 01 - equilateral
   // System.out.println("Test case 01 - equilateral");
   // A = 3; B = 3; C= 3;
   // T = triang (A, B, C);
   // System.out.println ("Expected result is: equilateral\nActual result is: " + triTypes[T] + "\n");

   // //Test case 02 - isosceles
   // System.out.println("Test case 02 - isosceles");
   // A = 3; B = 3; C= 5;
   // T = triang (A, B, C);
   // System.out.println ("Expected result is: isosceles\nActual result is: " + triTypes[T] + "\n");
